...
<CardGroup cols={2}>
  <Card title="Docker Labels Reference" icon="tag" href="/routing/providers/docker">
    Complete list of Docker labels for routers, services, and middleware
  </Card>
  <Card title="Docker Swarm" icon="layer-group" href="/providers/swarm">
    Deploy Traefik in Docker Swarm mode
  </Card>
</CardGroup>